...
class InternetLostHomeScreen extends StatelessWidget {
  const InternetLostHomeScreen({
    super.key,
  ...
  final HiveDataModel weatherData;
           ...
           //Apply blur filter on container
            ...
            Column(
              ...
              // show current temp,status, date and time
                ...
                Center(
                  child: Text(
                    weatherData.weatherCondition.toString(),
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 25,
